...
def p():
    ...
    if stat == 0:
        pygame.draw.circle(screen,[55,171,226],[100,50],15,0)
        pygame.draw.circle(screen,[86,102,174],[85,80],15,0)
        pygame.draw.circle(screen,[40,158,147],[85,120],15,0)
        pygame.draw.circle(screen,[150,195,99],[100,150],15,0)
    if stat == 1:
        pygame.draw.circle(screen,[55,171,226],[100,50],15,0)
        pygame.draw.circle(screen,GRAY,[85,80],15,0)
        pygame.draw.circle(screen,GRAY,[85,120],15,0)
        pygame.draw.circle(screen,GRAY,[100,150],15,0)
    if stat == 2:
        pygame.draw.circle(screen,GRAY,[100,50],15,0)
        pygame.draw.circle(screen,[86,102,174],[85,80],15,0)
        pygame.draw.circle(screen,GRAY,[85,120],15,0)
        pygame.draw.circle(screen,GRAY,[100,150],15,0)
    if stat == 3:
